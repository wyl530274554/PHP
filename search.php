...
<html>
    <body class="main">
        ...
        <div align="center">
			...
			<img src="https://ss0.bdstatic.com/5aV1bjqh_Q23odCf/static/superman/img/logo/bd_logo1_31bdc765.png" width="270" height="130" /><br /><br />			
            <input id="content" style="height:40px;" class="normalInput" onBlur="inputLineDef(this)" onFocus="inputLineFocus(this)"/>
...
.normalInput { outline:none; border:1px solid #b8b8b8; } 
.focusInput { outline:none;  border:1px solid green; } 
</style>
